...
/**
 * Mapping of predefined team names based on their numeric identifier.
 * Note: Inserting a specific team name is optional/not mandatory.
 *
 * @constant
...
export const WORDS = [
  ...
  createWord(
    ...
    6,
    0,
    'Il suo canto era legato a una profezia di Gesù - 5 LETTERE',
  ),
  ...
  createWord(
    ...
    13,
    2,
    'Inconsueto, insolito, fuori dell’ordinario - 6 LETTERE',
  ),
  createWord(
    'ANZIANITA',
    'down',
    3,
    10,
    'Non la hanno i pischelli - 9 LETTERE',
  ),
  createWord(
    'VETRINA',
    'down',
    7,
    5,
    'La finestra tentatrice della Betel - 7 LETTERE',
  ),
  ...
  createWord(
    ...
    11,
    7,
    'La capitale di un paese che ci ha tolto forza lavoro - 6 LETTERE',
  ),
  createWord(
    'TOSATI',
    'across',
    9,
    5,
    'I pecoroni non lo sono se zompano il taglio capelli - 6 LETTERE',
  ),
  createWord(
    'ALBERO',
    'down',
    7,
    14,
    'Si riconosce dal suo frutto - 6 LETTERE',
  ),
  ...
  createWord(
    ...
    7,
    12,
    'Il suo legno fu usato per l’arca del patto - 6 LETTERE',
  ),
  ...
  createWord(
    ...
    6,
    3,
    'Il primo poligamo menzionato nella Bibbia - 5 LETTERE',
  ),
